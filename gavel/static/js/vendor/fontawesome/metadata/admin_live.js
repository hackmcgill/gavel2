...
async function initTables() {
  ...
  itemDefs = [
    ...
    {headerName:"ID", field: "id", width: standardIdWidth, minWidth: minIdWidth, cellRenderer: ItemIdRenderer},
    {
      ...
      children: [
        ...
        [{headerName:"Discord Channel", width: standardLocationWidth, minWidth: minDecimalWidth, field:"discord_channel", filter: true, columnGroupShow: "open"}],
  ...
  flagDefs = [
    ...
    {headerName:"Project Discord Channel", field:"item_discord_channel", width: standardLocationWidth},
